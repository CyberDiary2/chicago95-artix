...
# ── chicago95 theme (packages only -- xfconf applied by apply-theme.sh) ───────
setup_chicago95() {
    log "installing chicago95 theme packages"
    aur chicago95-gtk-theme-git chicago95-icon-theme-git ttf-ms-fonts
    log "chicago95 packages installed -- run ./apply-theme.sh from inside XFCE to activate"
}
